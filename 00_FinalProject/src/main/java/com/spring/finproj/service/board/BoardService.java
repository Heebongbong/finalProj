...
public interface BoardService {
	public int writeBoard(BoardDTO boardDTO, MultipartFile[] files, HttpServletRequest request, String[] category) throws Exception;
	...
	public int updateBoard(BoardDTO boardDTO, MultipartFile[] files, HttpServletRequest request, String[] deletefile, String[] category) throws Exception;
