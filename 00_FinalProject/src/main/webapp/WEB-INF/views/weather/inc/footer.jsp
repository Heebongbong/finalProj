...
<div id="weather_footer">
	<ul class="move_navi">
		...
		<li><a class="navi_footer_a" href="${ctxPath }/weater/content"><img alt="" src="${ctxPath }/resources/images/icon/cloud_icon.png"><span>구름양</span></a></li>
...
<<<<<<< Upstream, based on branch 'NJH' of https://github.com/Heebongbong/finalProj.git
		<li><a class="navi_footer_a" href="${ctxPath }/weather/content"><img alt="" src="${ctxPath }/resources/images/icon/weather_icon.png"><span>날씨</span></a></li>
=======
		<li><a class="navi_footer_a" href="${ctxPath }/weather/weather"><img alt="" src="${ctxPath }/resources/images/icon/weather_icon.png"><span>날씨</span></a></li>
>>>>>>> dcbb190 weather
